...
Я специализируюсь на проектировании и реализации высоконагруженных (Highload) и отказоустойчивых (Fault-tolerant) серверных систем. Мой подход базируется на обеспечении максимальной производительности при сохранении гибкости и чистоты кодовой базы.
